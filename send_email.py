...
receivers_emails = list(config.RECEIVER_EMAIL_ADDRESS)
...
def send():
    ...
    for idx,receiver_email in enumerate(receivers_emails):
        ...
        # em = EmailMessage()
        em = MIMEMultipart("alternative") # To Send An Html Email
        em['From'] = email_sender
        em['To'] = receiver_email
        em['Subject'] = subject
        # em.set_content(body)

        html = MIMEText(body, 'html') # Prepare Html Body
        em.attach(html) # Add The Body To The Email
